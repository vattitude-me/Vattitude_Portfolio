...
const projects = [
  ...
  },
  {
    ...
    category: 'apps',
    categoryLabel: 'Interactive Experience',
    description: 'A cinematic scroll-through of personal travel history — 25 destinations across 14 countries, with photo galleries, parallax transitions, and a live editor.',
