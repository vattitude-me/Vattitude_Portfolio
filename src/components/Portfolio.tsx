...
const projects = [
  ...
  {
    id: 8,
    title: 'The Travel Timeline',
    category: 'apps',
    categoryLabel: 'Interactive Experience',
    description: 'A travelogue read backwards, set as newsprint — 30 entries across 17 countries, every photograph printed as its four misregistered process plates until you hover and the press comes into register.',
